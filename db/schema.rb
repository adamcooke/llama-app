...
ActiveRecord::Schema.define(version: 20170222203333) do
  ...
  create_table "authie_sessions", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["browser_id"], name: "index_authie_sessions_on_browser_id", length: { browser_id: 10 }, using: :btree
    t.index ["token"], name: "index_authie_sessions_on_token", length: { token: 10 }, using: :btree
